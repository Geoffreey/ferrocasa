window.angularApp.factory("LoanDeleteModal", ["API_URL", "window", "jQuery", "$http", "$uibModal", "$sce", "$rootScope", function(API_URL, window, $, $http, $uibModal, $sce, $scope) {
    return function(taxrate) {
        var uibModalInstance = $uibModal.open({
            ...
            template: "<div class=\"modal-header\">" +
                           "<button ng-click=\"closeLoanDeleteModal();\" type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>" +
            ...
            controller: function ($scope, $uibModalInstance) {
                ...
                $(document).delegate("#taxrate-delete", "click", function(e) {
                    ...
                    then(function(response) {
                        ...
                        // Devolver la llamada
                        if ($scope.LoanDeleteModalCallback) {
                            $scope.LoanDeleteModalCallback($scope);
                        }
                ...
                $scope.closeLoanDeleteModal = function () {
