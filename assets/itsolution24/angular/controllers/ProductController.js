  ...
  function (
    ...
    dt.dataTable({
      ...
      columnDefs: [
        ...
        { visible: false, targets: hideColumsArray },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#product-product-list thead tr th:eq(1)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#product-product-list thead tr th:eq(2)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#product-product-list thead tr th:eq(3)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#product-product-list thead tr th:eq(4)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#product-product-list thead tr th:eq(5)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#product-product-list thead tr th:eq(6)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#product-product-list thead tr th:eq(7)").html()
            );
          },
        },
        {
        ...
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#product-product-list thead tr th:eq(13)").html()
            );
          },
        },
      ],
      ...
      footerCallback: function (row, data, start, end, display) {
        ...
        // Actualizar pie de página
        $(api.column(7).footer()).html(window.formatDecimal(pageTotal, 2));
      },
    ...
    if (
      window.getParameterByName("p_id") &&
      window.getParameterByName("p_name")
    ) {
    ...
    $(document).delegate(".purchase-product", "click", function (e) {
      ...
      window.location =
        window.baseUrl +
        "/admin/purchase.php?box_state=open&p_code=" +
        $scope.product.p_code +
        "&sup_id=" +
        $scope.product.sup_id;
    });
    ...
    $("#email-btn").on("click", function (e) {
      ...
      e.preventDefault();
      dt.find(
        "thead th:nth-child(1), thead th:nth-child(2), thead th:nth-child(9), thead th:nth-child(10), thead th:nth-child(11), thead th:nth-child(12), thead th:nth-child(13), tbody td:nth-child(1), tbody td:nth-child(2), tbody td:nth-child(9), tbody td:nth-child(10), tbody td:nth-child(11), tbody td:nth-child(12), tbody td:nth-child(13), tfoot th:nth-child(1), tfoot th:nth-child(1), tfoot th:nth-child(9), tfoot th:nth-child(10), tfoot th:nth-child(11), tfoot th:nth-child(12), tfoot th:nth-child(13)"
      ).addClass("hide-in-mail");
      var thehtml = dt.html();
      EmailModal({
        template: "product-list",
        subject: "Product Listing",
