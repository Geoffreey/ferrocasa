  ...
  function (
    ...
    dt.dataTable({
      ...
      columnDefs: [
        ...
        { className: "text-center", targets: [0, 1, 8, 9, 10, 11] },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#loan-loan-list thead tr th:eq(0)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#loan-loan-list thead tr th:eq(1)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#loan-loan-list thead tr th:eq(2)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#loan-loan-list thead tr th:eq(3)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#loan-loan-list thead tr th:eq(4)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#loan-loan-list thead tr th:eq(5)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#loan-loan-list thead tr th:eq(6)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#loan-loan-list thead tr th:eq(7)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#loan-loan-list thead tr th:eq(8)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#loan-loan-list thead tr th:eq(9)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#loan-loan-list thead tr th:eq(10)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#loan-loan-list thead tr th:eq(11)").html()
            );
          },
        },
      ],
      ...
      footerCallback: function (row, data, start, end, display) {
        ...
        $(api.column(3).footer()).html(window.formatDecimal(pageTotal, 2));
    ...
    $scope.$watch("amount", function () {
      if ($scope.interest > 0) {
        $scope.payable =
          ...
          (parseFloat($scope.interest) / 100) * parseFloat($scope.amount);
      } else {
    ...
    $("#email-btn").on("click", function (e) {
      ...
      e.preventDefault();
      dt.find(
        "thead th:nth-child(9), thead th:nth-child(10), thead th:nth-child(11), thead th:nth-child(12), tbody th:nth-child(9), tbody th:nth-child(10), tbody th:nth-child(11), tbody th:nth-child(12), tfoot th:nth-child(9), tfoot th:nth-child(10), tfoot th:nth-child(11), tfoot th:nth-child(12)"
      ).addClass("hide-in-mail");
      var thehtml = dt.html();
      EmailModal({
        template: "default",
        subject: "Loan Listing",
        title: "Loan Listing",
        html: thehtml,
      });
    });
