window.angularApp.controller("InvoiceController", [
  ...
  function (
    ...
    $("#invoice-invoice-list").dataTable({
      ...
      columnDefs: [
        { targets: [1, 4, 5, 6, 7], orderable: false },
    ...
    $(document).delegate("#pay_now", "click", function (e) {
      ...
      $http({
        url:
          window.baseUrl +
          "/_inc/payment.php?action_type=ORDERDETAILS&invoice_id=" +
          d.invoice_id,
        method: "GET",
      }).then(
    ...
    $(document).delegate("#customer_id", "select2:select", function (e) {
      ...
      window.location =
        window.baseUrl + "/admin/invoice.php?customer_id=" + data.element.value;
    });
    ...
    $("#email-btn").on("click", function (e) {
      ...
      e.preventDefault();
      dt.find(
        "thead th:nth-child(6), thead th:nth-child(7), thead th:nth-child(8), thead th:nth-child(9), tbody td:nth-child(6), tbody td:nth-child(7), tbody td:nth-child(8), tbody td:nth-child(9), tfoot th:nth-child(6), tfoot th:nth-child(7), tfoot th:nth-child(8), tfoot th:nth-child(9)"
      ).addClass("hide-in-mail");
      var thehtml = dt.html();
      EmailModal({
        template: "default",
        subject: "Sell Invoice Listing",
        title: "Sell Invoice Listing",
        html: thehtml,
      });
    });
  },
