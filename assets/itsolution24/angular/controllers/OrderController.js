window.angularApp.controller("OrderController", [
  ...
  function (
        ...
        columnDefs: [
          ...
          { className: "text-center", targets: [0, 2, 3, 5, 6] },
          {
            ...
            createdCell: function (td, cellData, rowData, row, col) {
              $(td).attr(
                "data-title",
                $("#order-order-list thead tr th:eq(0)").html()
              );
            },
          },
          {
            ...
            createdCell: function (td, cellData, rowData, row, col) {
              $(td).attr(
                "data-title",
                $("#order-order-list thead tr th:eq(1)").html()
              );
            },
          },
          {
            ...
            createdCell: function (td, cellData, rowData, row, col) {
              $(td).attr(
                "data-title",
                $("#order-order-list thead tr th:eq(2)").html()
              );
            },
          },
          {
            ...
            createdCell: function (td, cellData, rowData, row, col) {
              $(td).attr(
                "data-title",
                $("#order-order-list thead tr th:eq(3)").html()
              );
            },
          },
          {
            ...
            createdCell: function (td, cellData, rowData, row, col) {
              $(td).attr(
                "data-title",
                $("#order-order-list thead tr th:eq(4)").html()
              );
            },
          },
          {
            ...
            createdCell: function (td, cellData, rowData, row, col) {
              $(td).attr(
                "data-title",
                $("#order-order-list thead tr th:eq(5)").html()
              );
            },
          },
          {
            ...
            createdCell: function (td, cellData, rowData, row, col) {
              $(td).attr(
                "data-title",
                $("#order-order-list thead tr th:eq(6)").html()
              );
            },
          },
        ],
    ...
    if (window.sendReportEmail) {
      $(".dt-buttons").append(
        '<button id="email-btn" class="btn btn-default buttons-email" tabindex="0" aria-controls="order-order-list" type="button" title="Email"><span><i class="fa fa-envelope"></i></span></button>'
      );
    }
