...
function (
    ...
    $("#email-btn").on( "click", function (e) {
        e.stopPropagation();
        e.preventDefault();
        dt.find("thead th:nth-child(9), tbody td:nth-child(9), tfoot th:nth-child(9)").addClass("hide-in-mail");
        var thehtml = dt.html();
        EmailModal({template: "default", subject: "Expired/Expiring Product Listing", title:"Expired/Expiring Product Listing", html: thehtml});
    });
}]);