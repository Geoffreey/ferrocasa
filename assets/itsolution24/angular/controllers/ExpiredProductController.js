window.angularApp.controller("ExpiredProductController", [
  ...
  function (
    ...
    dt.dataTable({
      ...
      dom: "lfBrtip",
      serverSide: true,
      ajax: API_URL + "/_inc/product.php?expired_query=1&type=" + type,
      fixedHeader: true,
      order: [[0, "desc"]],
      aLengthMenu: [
        [10, 25, 50, 100, 200, -1],
    ...
    $("#email-btn").on("click", function (e) {
      ...
      e.preventDefault();
      dt.find(
        "thead th:nth-child(9), tbody td:nth-child(9), tfoot th:nth-child(9)"
      ).addClass("hide-in-mail");
      var thehtml = dt.html();
      EmailModal({
        template: "default",
        subject: "Expired/Expiring Product Listing",
        title: "Expired/Expiring Product Listing",
        html: thehtml,
      });
    });
  },
