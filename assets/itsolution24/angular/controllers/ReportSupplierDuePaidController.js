window.angularApp.controller("ReportSupplierDuePaidController", [
  ...
  function (
    ...
    $("#invoice-invoice-list").dataTable({
      ...
      ajax:
        API_URL +
        "/_inc/report_supplier_due_paid.php?from=" +
        $from +
        "&to=" +
        $to,
      fixedHeader: true,
    ...
    $("#email-btn").on("click", function (e) {
      ...
      e.preventDefault();
      dt.find(
        "thead th:nth-child(5), tbody td:nth-child(5), tfoot th:nth-child(5)"
      ).addClass("hide-in-mail");
      var thehtml = dt.html();
      EmailModal({
        template: "report",
        subject: "Supplier's Duepaid Report",
        title: "Supplier's Duepaid Report",
        html: thehtml,
      });
    });
  },
