window.angularApp.controller("ExpenseCategoryController", [
  ...
  function (
      ...
      columnDefs: [
        ...
        { className: "text-right", targets: [2] },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#category-category-list thead tr th:eq(0)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#category-category-list thead tr th:eq(1)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#category-category-list thead tr th:eq(2)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#category-category-list thead tr th:eq(3)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#category-category-list thead tr th:eq(4)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#category-category-list thead tr th:eq(5)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#category-category-list thead tr th:eq(6)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#category-category-list thead tr th:eq(7)").html()
            );
          },
        },
      ],
    ...
    $(document).delegate(
      "#create-expense-category-submit",
      "click",
      function (e) {
        e.preventDefault();
    ...
    if (
      window.getParameterByName("category_id") &&
      window.getParameterByName("category_name")
    ) {
      ...
      dt.DataTable().ajax.reload(function (json) {
        $.each(json.data, function (index, obj) {
          if (obj.DT_RowId === "row_" + expense_categoryId) {
            ExpenseCategoryEditModal({
              category_id: expense_categoryId,
