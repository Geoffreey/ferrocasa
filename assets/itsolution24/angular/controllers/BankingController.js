...
function (
        ...
        "buttons": [
            {
                ...
                customize: function ( win ) {
                    $(win.document.body)
                        .css( 'font-size', '10pt' )
                        .append(
                            '<div><b><i>Developed & Maintained by: web.ferrocasa.pw</i></b></div>'
                        )
                        .prepend(
            ...
            },
            {
                ...
                titleAttr: "Copy",
                title: window.store.name + " > Transactions Listing-"+from+" to "+to,
                exportOptions: {
                    columns: [ 0, 1, 2, 3, 4, 5, 6 ]
                }
            },
    ...
    $("#email-btn").on( "click", function (e) {
        ...
        var thehtml = dt.html();
        EmailModal({template: "default", subject: "Bank Transaction Listinig", title:"Bank Transaction Listinig", html: thehtml});
    });
}]);
