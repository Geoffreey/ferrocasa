window.angularApp.controller("BankingController", [
  ...
  function (
      ...
      buttons: [
        {
          ...
          titleAttr: "Print",
          title: "Transactions Listing-" + from + " to " + to,
        ...
        },
        {
          ...
          titleAttr: "Copy",
          title:
            window.store.name + " > Transactions Listing-" + from + " to " + to,
          exportOptions: {
            columns: [0, 1, 2, 3, 4, 5, 6],
          },
        },
    ...
    if (window.sendReportEmail) {
      $(".dt-buttons").append(
        '<button id="email-btn" class="btn btn-default buttons-pdf buttons-email" tabindex="0" aria-controls="invoice-invoice-list" type="button" title="Email"><span><i class="fa fa-envelope"></i></span></button>'
      );
    }
    ...
    $("#email-btn").on("click", function (e) {
      ...
      e.preventDefault();
      dt.find(
        "thead th:nth-child(8), tbody td:nth-child(8), tfoot th:nth-child(8)"
      ).addClass("hide-in-mail");
      var thehtml = dt.html();
      EmailModal({
        template: "default",
        subject: "Bank Transaction Listinig",
        title: "Bank Transaction Listinig",
        html: thehtml,
      });
    });
  },
