window.angularApp.controller("ReportSellItemWiseController", [
  "$scope",
  "API_URL",
  "window",
  "jQuery",
  ...
  function (
    ...
    dt.dataTable({
      ...
      ajax:
        API_URL +
        "/_inc/report_sell_itemwise.php?from=" +
        $from +
        "&to=" +
        $to +
        "&pid=" +
      ...
      columnDefs: [
        ...
        { className: "text-center", targets: [0, 1] },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#report-report-list thead tr th:eq(0)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#report-report-list thead tr th:eq(1)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#report-report-list thead tr th:eq(2)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#report-report-list thead tr th:eq(3)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#report-report-list thead tr th:eq(4)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#report-report-list thead tr th:eq(5)").html()
            );
          },
        },
      ],
      ...
      buttons: [
        {
          ...
          titleAttr: "Print",
          title: "Sell's Report (Item wise)-" + from + " to " + to,
        ...
        },
        {
          ...
          titleAttr: "CSV",
          title: window.store.name + " > Sell's Report (Item wise)",
          exportOptions: {
            columns: [printColumns],
          },
        },
    ...
    $("#email-btn").on("click", function (e) {
      ...
      EmailModal({
        template: "report",
        subject: "Sell's Report (Item Wise)",
        title: "Sell's Report (Item Wise)",
        html: thehtml,
      });
    });
  },
