window.angularApp.controller("InstallmentController", [
  ...
  function (
      ...
      columnDefs: [
        ...
        { visible: false, targets: hideColumsArray },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#installment-installment-list thead tr th:eq(0)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#installment-installment-list thead tr th:eq(1)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#installment-installment-list thead tr th:eq(2)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#installment-installment-list thead tr th:eq(3)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#installment-installment-list thead tr th:eq(4)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#installment-installment-list thead tr th:eq(5)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#installment-installment-list thead tr th:eq(6)").html()
            );
          },
        },
        {
    ...
    if (window.sendReportEmail) {
      $(".dt-buttons").append(
        '<button id="email-btn" class="btn btn-default buttons-email" tabindex="0" aria-controls="installment-installment-list" type="button" title="Email"><span><i class="fa fa-envelope"></i></span></button>'
      );
    }
    ...
    $("#email-btn").on("click", function (e) {
      ...
      EmailModal({
        template: "default",
        subject: "Installment Listing",
        title: "Installment Listing",
        html: thehtml,
      });
    });
  },
