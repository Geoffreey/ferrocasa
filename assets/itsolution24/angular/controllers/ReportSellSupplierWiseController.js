window.angularApp.controller("ReportSellSupplierWiseController", [
  ...
  function (
    ...
    dt.dataTable({
      ...
      ajax:
        API_URL +
        "/_inc/report_sell_supplierwise.php?from=" +
        $from +
        "&to=" +
        $to,
      fixedHeader: true,
    ...
    $("#email-btn").on("click", function (e) {
      ...
      var thehtml = dt.html();
      EmailModal({
        template: "sell-report",
        subject: "Sell's Report (Supplier Wise)",
        title: "Sell's Report (Supplier Wise)",
        html: thehtml,
      });
    });
  },
