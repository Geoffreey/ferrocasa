window.angularApp.controller("CustomerProfileController", [
  ...
  function (
    ...
    dt.dataTable({
      ...
      ajax:
        API_URL +
        "/_inc/customer_profile.php?customer_id=" +
        customer_id +
        "&from=" +
        $from +
        "&to=" +
    ...
    $(document).delegate("#customer_id", "select2:select", function (e) {
      ...
      window.location =
        window.baseUrl +
        "/admin/customer_profile.php?customer_id=" +
        data.element.value;
    });
    ...
    if (
      ...
      window.getParameterByName("paid_form")
    ) {
