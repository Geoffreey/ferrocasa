  ...
  function (
    ...
    dt.dataTable({
      ...
      columnDefs: [
        ...
        { className: "text-center", targets: [0] },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#account-list thead tr th:eq(0)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#account-list thead tr th:eq(1)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#account-list thead tr th:eq(2)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#account-list thead tr th:eq(3)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#account-list thead tr th:eq(4)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#account-list thead tr th:eq(5)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#account-list thead tr th:eq(6)").html()
            );
          },
        },
      ],
      ...
      footerCallback: function (row, data, start, end, display) {
        ...
        $(api.column(2).footer()).html(formatDecimal(pageTotal, 2));
        ...
        // Actualizar pie de página
        $(api.column(3).footer()).html(formatDecimal(pageTotal, 2));
        ...
        // Actualizar pie de página
        $(api.column(6).footer()).html(formatDecimal(pageTotal, 2));
      },
