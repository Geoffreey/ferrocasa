window.angularApp.controller("ReportSellPaymentController", [
  ...
  function (
    ...
    dt.dataTable({
      ...
      serverSide: true,
      ajax:
        API_URL + "/_inc/report_sell_payment.php?from=" + $from + "&to=" + $to,
      fixedHeader: true,
      aLengthMenu: [
        [10, 25, 50, 100, 200, -1],
      ...
      columnDefs: [
        ...
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#report-report-list thead tr th:eq(6)").html()
            );
          },
        },
      ],
    ...
    $("#email-btn").on("click", function (e) {
      ...
      EmailModal({
        template: "report",
        subject: "Sell Sell's Payment Report",
        title: "Sell Sell's Payment Report",
        html: thehtml,
      });
    });
  },
