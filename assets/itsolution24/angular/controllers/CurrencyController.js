window.angularApp.controller("CurrencyController", [
  ...
  function (
      ...
      columnDefs: [
        ...
        { visible: false, targets: hideColumsArray },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#currency-currency-list thead tr th:eq(0)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#currency-currency-list thead tr th:eq(1)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#currency-currency-list thead tr th:eq(2)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#currency-currency-list thead tr th:eq(3)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#currency-currency-list thead tr th:eq(4)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#currency-currency-list thead tr th:eq(5)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#currency-currency-list thead tr th:eq(6)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#currency-currency-list thead tr th:eq(7)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#currency-currency-list thead tr th:eq(8)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#currency-currency-list thead tr th:eq(9)").html()
            );
          },
        },
      ],
    ...
    $(document).delegate(".currency-change", "click", function (e) {
      ...
      $http({
        ...
        function (response) {
          ...
          // Alert
          window
            .swal("Success", "Currency activated", "success")
            .then(function (value) {
    ...
    if (
      window.getParameterByName("currency_id") &&
      window.getParameterByName("title")
    ) {
