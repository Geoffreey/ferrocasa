window.angularApp.controller("ReportProductPurchaseController", [
  ...
  function ($scope, API_URL, window, $, $compile, $uibModal, $http, $sce) {
    ...
    dt.dataTable({
      ...
      ajax:
        API_URL +
        "/_inc/report_purchase_the_itemwise.php?from=" +
        $from +
        "&to=" +
        $to +
        "&pid=" +
        ...
        { className: "text-center", targets: [0, 5, 6, 7, 8] },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $(
                "#purchasereport-purchasereport-list-list thead tr th:eq(0)"
              ).html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $(
                "#purchasereport-purchasereport-list-list thead tr th:eq(1)"
              ).html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $(
                "#purchasereport-purchasereport-list-list thead tr th:eq(2)"
              ).html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $(
                "#purchasereport-purchasereport-list-list thead tr th:eq(3)"
              ).html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $(
                "#purchasereport-purchasereport-list-list thead tr th:eq(4)"
              ).html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $(
                "#purchasereport-purchasereport-list-list thead tr th:eq(5)"
              ).html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $(
                "#purchasereport-purchasereport-list-list thead tr th:eq(6)"
              ).html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $(
                "#purchasereport-purchasereport-list-list thead tr th:eq(7)"
              ).html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $(
                "#purchasereport-purchasereport-list-list thead tr th:eq(8)"
              ).html()
            );
          },
        },
