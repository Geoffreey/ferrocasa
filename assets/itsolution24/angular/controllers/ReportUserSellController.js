window.angularApp.controller("ReportUserSellController", [
  "$scope",
  "API_URL",
  "window",
  "jQuery",
  ...
  function ($scope, API_URL, window, $, $compile, $uibModal, $http, $sce) {
    ...
    dt.dataTable({
      ...
      columnDefs: [
        ...
        { className: "text-center", targets: [0, 1, 3, 8, 9] },
        {
          targets: [0],
      ...
      buttons: [
        {
          ...
          titleAttr: "Print",
          title: "Sell Report (user wise)-" + from + " to " + to,
          stripHtml: false,
