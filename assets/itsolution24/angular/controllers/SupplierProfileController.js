window.angularApp.controller("SupplierProfileController", [
  ...
  function (
    ...
    dt.dataTable({
      ...
      ajax:
        API_URL +
        "/_inc/supplier_profile.php?sup_id=" +
        sup_id +
        "&from=" +
        $from +
        "&to=" +
      ...
      columnDefs: [
        ...
        { className: "text-center", targets: [0, 4, 6, 7, 8, 9] },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#product-product-list thead tr th:eq(0)").html()
            );
          },
        },
        {
      ...
      buttons: [
        {
          ...
          titleAttr: "Print",
          title:
            window.supplier.sup_name + " Invoice List-" + from + " to " + to,
        ...
        },
        {
          ...
          customize: function (doc) {
            ...
            doc.content.splice(1, 0, {
              ...
              alignment: "center",
              fontSize: 18,
              text: "Suppplier Name: " + window.supplier.sup_name,
            });
    ...
    $(document).delegate("#purchase-btn", "click", function (e) {
        ...
        PurchaseProductModal({sup_id:sup_id,sup_name:sup_name, invoice_id:null});
    });

    // add product by query string
    if (window.getParameterByName("sup_id") && window.getParameterByName("sup_name") && window.getParameterByName("purchase")) {
	...
	*/
    ...
    $(document).delegate("#sup_id", "select2:select", function (e) {
      ...
      window.location =
        window.baseUrl +
        "/admin/supplier_profile.php?sup_id=" +
        data.element.value;
    });
