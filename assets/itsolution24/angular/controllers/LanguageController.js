window.angularApp.controller("LanguageController", [
  ...
  function (
    ...
    dt.dataTable({
      ...
      ajax:
        API_URL +
        "/_inc/language.php?ignore_lang_change=yes&lang=" +
        $lang +
        "&key_type=" +
        $keyType +
        "&action_type=" +
      ...
      columnDefs: [
        ...
        { visible: false, targets: hideColumsArray },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#language-language-list thead tr th:eq(0)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#language-language-list thead tr th:eq(1)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#language-language-list thead tr th:eq(2)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#language-language-list thead tr th:eq(3)").html()
            );
          },
        },
      ],
