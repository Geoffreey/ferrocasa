window.angularApp.controller("ReportCollectionController", [
  ...
  function (
    ...
    collectionReportDT.dataTable({
      ...
      ajax:
        API_URL +
        "/_inc/report_collection.php?from=" +
        $from +
        "&to=" +
        $to +
        "&user_id=" +
      ...
      columnDefs: [
        ...
        { className: "text-center", targets: [0, 2] },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#report_collection thead tr th:eq(0)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#report_collection thead tr th:eq(1)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#report_collection thead tr th:eq(2)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#report_collection thead tr th:eq(3)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#report_collection thead tr th:eq(4)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#report_collection thead tr th:eq(5)").html()
            );
          },
        },
        {
          ...
          createdCell: function (td, cellData, rowData, row, col) {
            $(td).attr(
              "data-title",
              $("#report_collection thead tr th:eq(6)").html()
            );
          },
        },
        {
      ...
      buttons: [
        ...
        },
        {
          ...
          titleAttr: "Copy",
          title:
            window.store.name + " > Collection Report-" + from + " to " + to,
          exportOptions: {
            columns: [0, 1, 2, 3, 4, 5, 6, 7],
          },
        },
    ...
    $(document).delegate("#user_id", "select2:select", function (e) {
      ...
      window.location =
        window.baseUrl +
        "/admin/report_collection.php?user_id=" +
        data.element.value;
    });
